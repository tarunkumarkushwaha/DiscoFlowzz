...
const SideBar = ({ sidebar, toggleNav }) => {
    ...
    return (
        <>
            <aside ref={menuRef} className={`fixed smooth-entry z-20 top-0 left-0 h-full transition-all duration-1000 ease-in-out ${!sidebar ? "sm:w-[25vw] w-[60vw] -translate-x-full" : "sm:w-[30vw] w-[50vw] -translate-x-1"}`}>
