            ...
            <aside className={`relative z-10 top-0 left-0 h-[88vh] w-[12vw] border border-gray-300`}>
                <div className="h-full py-1 overflow-y-auto bg-gray-100 overflow-hidden">
                    <ul className="my-1 font-medium flex flex-col items-center justify-center">
                        <li onClick={() => setSetting(0)} className='cursor-pointer flex flex-col items-center justify-center rounded-xl p-3 w-20 m-1 bg-slate-200'>
                            <SettingsIcon />
                            <p className='text-sm'>Setting</p>
                        </li>
                        <li onClick={() => setSetting(1)} className='cursor-pointer flex flex-col items-center justify-center rounded-xl p-3 w-20 m-1 bg-slate-200'>
                            <ControlPointIcon />
                            <p className='text-sm'>Assets</p>
                        </li>
                        <li onClick={() => setSetting(2)} className='cursor-pointer flex flex-col items-center justify-center rounded-xl p-3 w-20 m-1 bg-slate-200'>
                            <AudiotrackIcon />
                            <p className='text-sm'>Audio</p>
                        </li>
                        <li onClick={() => setSetting(3)} className='cursor-pointer flex flex-col items-center justify-center rounded-xl p-3 w-20 m-1 bg-slate-200'>
                            <SubtitlesIcon />
